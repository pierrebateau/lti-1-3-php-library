...
class LTI_Message_Launch {
    ...
    private function validate_registration() {
        ...
        // Find registration.
        $this->registration = $this->db->find_registration_by_issuer_and_client_id($this->jwt['body']['iss'], $client_id);
    ...
    private function validate_deployment() {
        ...
        // Find deployment.
        $deployment = $this->db->find_deployment($this->jwt['body']['iss'], $client_id, $this->jwt['body'][LTI_Constants::DEPLOYMENT_ID]);
